...
│   │   ├── 📁 ubuntu-server-2/      # Nextcloud + EuroOffice, Crafty, Dockhand (3 compose)
...
> **Important:** This server now runs a **Docker Compose Nextcloud + EuroOffice** stack. The previous Nextcloud AIO deployment was replaced.

| Service | Purpose | Port | Compose |
|---------|---------|------|--------|
| Nextcloud + EuroOffice | Personal cloud + online document editing | 8081/8082 | [✅](docs/docker-compose/ubuntu-server-2/nextcloud-eurooffice/docker-compose.yml) |
...
**Old Nextcloud AIO compose:** [nextcloud-aio/docker-compose.yml](docs/docker-compose/ubuntu-server-2/nextcloud-aio/docker-compose.yml) — replaced by Nextcloud + EuroOffice.
